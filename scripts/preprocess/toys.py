#!/usr/bin/env python3
# GMEx/scripts/preprocess/toys.py
...
from gmex.utils import (
    STATE_LIST_FN, GROUPS_FN, RATES_FN, METADATA_FN, get_data_dir, save_metadata
)
...
if __name__ == "__main__":
    ...
    for toyname in RATES.keys():
        print(f'Saving {str(toyname)} toy data...')
        ...
        print(f'Saved {str(toyname)} toy data to {str(outdir)}.')

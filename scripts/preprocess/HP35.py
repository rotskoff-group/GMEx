#!/usr/bin/env python3
# GMEx/scripts/preprocess/HP35.py
...
from gmex.utils import STATE_LIST_FN, METADATA_FN, GROUPS_FN, get_data_dir, save_metadata
...
if __name__ == "__main__":
    ...
    print(f'HP35 data saved to {str(Path(os.getcwd()) / OUTDIR)}.')

#!/usr/bin/env python3
# GMEx/scripts/train/BMF1_ATPgS_1uM.py
...
MAIN_RES_GS_FN = 'BMF1-ATPgS-1uM-M6-L16-TCL-Gs.pt' # filename to save mean TCL-GME-DT propagators
...
if __name__ == "__main__":
    ...
    print(f'BMF1 (1uM ATPgS) models saved to {str(RES_DIR)}')
